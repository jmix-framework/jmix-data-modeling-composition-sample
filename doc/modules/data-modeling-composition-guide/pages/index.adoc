...
* xref:data-model:entities.adoc#references[Entity References in Jmix Data Model]
* xref:data-model:entities.adoc#composition[Composition Relationships in Jmix]
* xref:flow-ui:data/data-context.adoc[Data Components: DataContext]
* xref:concepts:features.adoc#editing-aggregates[Editing Aggregates in Jmix]
